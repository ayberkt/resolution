...
let rec prtFormExp (i:int) (e:formExp) : doc = match e with
       PropName ident -> prPrec i 3 (concatD [prtIdent 0 ident])
  |    ConjExp (formexp1, formexp2) -> prPrec i 2 (concatD [prtFormExp 2 formexp1 ; render "/\\" ; prtFormExp 3 formexp2])
  |    DisjExp (formexp1, formexp2) -> prPrec i 0 (concatD [prtFormExp 0 formexp1 ; render "\\/" ; prtFormExp 2 formexp2])


and prtForm (i:int) (e:form) : doc = match e with
       Conj (form1, form2) -> prPrec i 0 (concatD [prtForm 0 form1 ; render "/\\" ; prtForm 0 form2])
  |    Disj (form1, form2) -> prPrec i 0 (concatD [prtForm 0 form1 ; render "\\/" ; prtForm 0 form2])
  |    Prop integer -> prPrec i 0 (concatD [prtInt 0 integer])
